...
_C.TRAIN.RANDOM_ROTATION_3D = True#True
_C.TRAIN.RANDOM_TRANSLATION_3D = True#True
...
_C.TEST.PATH = ''
_C.TEST.N_VIEWS = 5
_C.TEST.N_WORKERS = 16

# model
_C.MODEL = CN()
_C.MODEL.N_VOX = [128, 224, 192]
_C.MODEL.VOXEL_SIZE = 1.5
...
_C.MODEL.PIXEL_MEAN = [101.17104336067483, 99.66408495019984, 88.46066116756863]
_C.MODEL.PIXEL_STD = [8.336836761607897, 8.3383196902244, 7.826302827265668]
_C.MODEL.THRESHOLDS = [0, 0, 0]
_C.MODEL.POS_WEIGHT = 1.0

#_C.MODEL.N_POINTS: [24,48,96]
